...
public class LeetCodeSolution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(maximumInvitations(favorite1));

        int[] favorite2 = new int[]{1,2,0};
        System.out.println(maximumInvitations(favorite2));

        int[] favorite3 = new int[]{3,0,1,4,1};
        System.out.println(maximumInvitations(favorite3));
    ...
    public static int maximumInvitations(int[] favorite) {
        ...
        for (int person = 0; person < n; ++person) {
            if (inDegree[person] == 0) { q.offer(person); }
        }
